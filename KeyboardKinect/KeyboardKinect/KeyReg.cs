...
namespace KeyboardKinect
{
    class KeyReg
    {
        //Represents short code
        private int checkcaps;
        ...
        public KeyReg(String a)
        {
            ...
            else if (asciiBytes[0] <= 122 && asciiBytes[0] >= 97)
            {
                value = "KEY_" + a;
                checkcaps = 1;
            }
        ...
        public static Boolean SendInputWithAPI(KeyReg a)
        {
            if (a.checkcaps == 1)
            {
                String Stringshort = a.value;
                INPUT[] Inputs = new INPUT[1];
                INPUT Input = new INPUT();

                ScanCodeShort Shortcode = (ScanCodeShort)Enum.Parse(typeof(ScanCodeShort), Stringshort, true);
